...
#define ALPHA (LAST_LOWER_SYM-FIRST_LOWER_SYM+1) // Кол-во символов алфавита
//-----------------------------------------------------------------------------
...
#define DEBUG_INFO true   // Выводить (да/нет) побочные сообщения
//#define DEBUG           // Активировать режим отладки (вывод всех сообщений)
//-----------------------------------------------------------------------------
extern ostream *logs;          // Глобальный поток логов
bool initLog(string fileName); // Поднять поток для записи логов
void saveLog();                // Убить поток логов
//-----------------------------------------------------------------------------
void showMsg(int type, string msg, ostream &out = *logs); // Вывод сообщения
//-----------------------------------------------------------------------------
class Word
{
 private:
